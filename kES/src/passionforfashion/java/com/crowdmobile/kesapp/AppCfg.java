...
public class AppCfg {
    ...
    public static final String TwitterKey = "iixBdQGWwSO7n4kx224Veor12";
    public static final String TwitterSecret = "LtQwrVHOh4HmgnfyeBnOJlR5wK9fBuyDwAOOZ7Emv1WT17TKl9";
}
